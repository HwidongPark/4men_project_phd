        ...
        <div id="market-create-container" class="container ">
            <div class="justify-content-center">
                <form action="/fourmen/market/create" method="post" enctype="multipart/form-data" id="market-post-create-form">
                    ...
                    <input type="text" name="title" class="form-control mb-4" placeholder="제목" maxlength="50" autofocus required/>
                    <div class="my-2">
                    ...
                    <textarea name="description"  class="form-control my-2" rows="15" placeholder="내용" maxlength="1000" required></textarea>
                    <label>가격</label>
                    <input id="market-price" type="number" name="price" class="form-control mb-3" required>
                    <label>창작 연도</label>
                    <input id="market-created-year" type="number" name="yearCreated" class="form-control mb-3"/>
                    ...
                    <button id="btn-market-create-submit" type="button" class="btn btn-dark">작성</button>
