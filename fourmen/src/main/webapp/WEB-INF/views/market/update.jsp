        ...
        <div id="market-create-container" class="container w-75">
            <div class="justify-content-center">
                <form action="/fourmen/market/modify" method="post" enctype="multipart/form-data" id="market-post-update-form">
                    ...
                    <input type="text" name="title" class="form-control mb-3" placeholder="제목" maxlength="50" value="${ marketPost.title }" autofocus required>
                    <div>                        
                        <ul>
                    ...
                    <textarea name="description"  class="form-control my-2" rows="20" placeholder="내용" maxlength="1000" required>${ marketPost.descriptionKor }</textarea>
                    <label>가격:</label>
                    <input id="market-price" type="number" name="price" class="form-control mb-2" value="${ marketPost.price }" required>
                    <label>창작 연도:</label>
                    <input id="market-created-year" type="number" name="yearCreated" class="form-control mb-2" value="${ marketPost.yearCreated }"/>
