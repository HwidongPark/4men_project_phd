        ...
        <div class="forum-kategorie">
            <ul class="forum-kategorie-board-lists">
                <li class="forum-kategorie-board">
                    <a href="freeboard" class="category-button forum-kategori-current-selected" onclick="change_category_style(event)">자유게시판</a>
                </li>
                <li class="forum-kategorie-board">
        ...
        <div>
            ...
            <form id="freeboard-create-form" action="/forum/freeboard-create" method="post" enctype="multipart/form-data">
                <div id="freeboard-create-title">
                    <input id="post_title" name="post_title" type="text" placeholder="제목을 입력하세요 (공백 포함 40자)" maxlength="40" onkeyup="return input_maxlength(this)"/>
                </div>
                <div id="freeboard-create-content">
                    <textarea id="post_content" name="post_content" placeholder="내용을 입력하세요 (공백 포함 1000자)" maxlength="1000" onkeyup="return textarea_maxlength(this)"></textarea>
                </div>
