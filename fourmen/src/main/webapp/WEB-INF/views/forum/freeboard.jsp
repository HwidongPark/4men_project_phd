...
<body>
    ...
    <main class="gfont">
        ...
        <section role="kategorie" class="kategorie"
            style="border-bottom: 1.5px solid #D8D8D8;">
            <div class="forum-kategorie">
                <ul class="forum-kategorie-board-lists">
                    ...
                    <li class="forum-kategorie-board"><a
                        href="noticeboard" class="category-button">NOTICE</a>
                    </li>
                </ul>
            </div>
        </section>
                    ...
                    <form action="${freeboard_searchPage}" method="get">
                        <div class="forum-search-select-area">
                            <select class="forum-select-box"
                                name="category">
                                <option class="forum-select-option"
                                    value="post_all">전체</option>
                                <option class="forum-select-option"
                                    value="post_title">제목</option>
                                <option class="forum-select-option"
                                    value="post_author">작성자</option>
                                <option class="forum-select-option"
                                    value="post_content">내용</option>
                            </select>
                        </div>
                        <div class="forum-search-form-area">
                            <input id="forum-search-input"
                                name="keyword" autocomplete="on"
                                placeholder="검색어를 입력하세요." type="text" maxlength="500">
                        </div>

                        <div class="forum-search-btn-area">
                            <button class="forum-search-btn"
                                type="submit">
                                <img id="forum-search-btn-img"
                                    alt="검색버튼"
                                    src="../icon/search01.svg">
                            </button>
                        </div>
                    </form>
                </div>
        ...
        <section class="freeboard-list"
            style="padding: 3.5rem 18.5rem 0rem 18.5rem;">
            <table class="table">
                <colgroup>
            ...
            -> model.addAttribute("freeboard_posts", list); //-> 뷰에 전달되는 데이터. -->
                        <tr>
                            ...
                            <td id="table-td"
                                ...
                                <c:url var="freeboard_postDetailPage"
                                    value="/forum/freeboard-detail">
                                    <c:param name="post_id"
                                        value="${p.post_id}" />
                                </c:url> <a href="${freeboard_postDetailPage}">${p.post_title}</a>
                            </td>
                            <td>${p.userid}</td>
        ...
        <div class="new-post-div">
            <nav class="new-post-nav">
                <ul class="new-post-ul">
                    <li id="new-post-li-one" class="new-post-li"><c:url
                            var="homePage" value="/" /> <a
                        href="${homePage}">HOME</a></li>
                    <li id="new-post-li-two" class="new-post-li"><c:url
                            var="siteMapPage" value="#" /> <a
                        href="${siteMapPage}">MAP</a></li>
                    <c:if test="${signedInUser ne null}">
                        <li id="new-post-li-three" class="new-post-li">
                            <c:url var="freeboardCreatePage"
                                value="/forum/freeboard-create" /> <a
                            href="${freeboardCreatePage}">NEW POST</a>
                        </li>
                    </c:if>
                </ul>
            </nav>
        ...
        <div>
            <nav aria-label="Page navigation">
                <ul class="pagination">
                    <!-- 처음 페이지 -->
                    <li class="page-item">
                        <a class="page-link-img" href="freeboard${pageMaker.makeSearchAdminUser(1)}">
                            <img id="pagination-img" alt="first page" src="/fourmen/pagination/pagination01.png">
                        </a>
                    </li>
                    <!-- 이전 페이지 -->
                    <li class="page-item">
                        <a class="page-link-img" href="freeboard${pageMaker.makeSearchAdminUser(page-1)}" aria-label="previous"> 
                    ...
                    <!-- 다음 페이지 -->
                    <li class="page-item">
                        <a class="page-link-img" href="freeboard${pageMaker.makeSearchAdminUser(page+1)}" aria-label="next"> 
                            <img id="pagination-img" alt="next page" src="/fourmen/pagination/pagination03.png">
                        </a>
                    </li>
                    <!-- 마지막 페이지 -->
                    <li class="page-item">
                        <a class="page-link-img" href="freeboard${pageMaker.makeSearchAdminUser(pageMaker.tempEndPage)}">
