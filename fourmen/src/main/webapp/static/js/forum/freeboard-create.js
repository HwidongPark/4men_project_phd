/**
 * freeboard-create.js
 * /forum/freeboard-create.jsp에 포함.
 * 새 포스트 작성 기능.
 */
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const inputTitle = document.querySelector('input#post_title');
    ...
    btnCreate.addEventListener('click', () => {
        ...
        // 제목, 내용이 비어있지 않으면:
        form.action = 'freeboard-create'; // 폼(양식)을 제출(submit)할 요청 주소. 기본값은 현재 URL.
        form.method = 'post'; // 폼 요청 방식(get/post). 기본값은 'get'.
        form.submit(); // 폼 제출(서버로 요청 보냄).
        //-> localhost:8081/fourmen/forum/freeboard-create 요청이 서버로 전달됨.
